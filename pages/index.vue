...
<script>
import EditComponent from '~/components/crud_movie/editComponent.vue'
import deleteComponent from '~/components/crud_movie/deleteComponent.vue';
export default {
  components:{
  ...
  data() {
      return {
          ...
          headers: [
              ...
              { text: 'Average Rate', value: 'averageRate', class: "green green-darken-1 white--text text-xs" },
